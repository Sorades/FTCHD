...
HF_CACHE_DIR = "/data0/wc_data/.cache/transformers"
HF_LOAD_KWARGS = {
    "cache_dir": "/data0/wc_data/.cache/transformers",
...
class ModelFactory(Enum):
    ...
    def feat_extractor(self, model: AutoModelForImageClassification) -> "FeatExtractFn":
        """Return the feature extractor function for the model

        Args:
            model (AutoModelForImageClassification): _description_
